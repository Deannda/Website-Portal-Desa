        ...
        @section('content')
                    <div class="col-lg-8">
                        <div class="blog-default marg-bot-50">
                            <a href="#"><h3>STATISTIK DATA BERDASARKAN PENDIDIKAN TERAKHIR</h3></a>
                          <br><br>


                            <div>
                                 <canvas id="pendidikan" height="100"></canvas>
                            </div>
                        ...
                        <div class="blog-detail-icon marg-bot-50">
                                ...
                                <h5>TABEL DATA DEMOGRAFI BERDASAR PENDIDIKAN TERAKHIR</h5>
                                    ...
                                    <tbody>
                                       ...
                                       @foreach($data as $key => $datas)
                                        <tr>
                                            ...
                                            <td class="title"><a class="link" href="javascript:void(0)">{{ $datas['pendidikan'] }}</a></td>
                        ...
                        <div class="friedman-one contact1-form">
                            ...
                            <form action="{{url('komentar/pendidikan')}}" method="post" class="horizontal">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <input placeholder="Nama" name="nama" type="text">
                                    </div>
                                    <input type="hidden" name="keterangan" value="datapendidikan" >
                                    <div class="col-md-6">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data){
                    ...
                    for (var i = 0; i < data.dataPendidikan.length; i++) {
                        pendidikan.push(data.dataPendidikan[i].original);
                    }

                    var ctx3 = document.getElementById("pendidikan").getContext("2d");

                    var data3 = pendidikan;
