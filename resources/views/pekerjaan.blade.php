		...
		@section('content')
					<div class="col-lg-8">
						<div class="blog-default marg-bot-50">
							<a href="#"><h3>STATISTIK DATA BERDASARKAN PEKERJAAN</h3></a>
							
							<br><br>

							<div>
                                <canvas id="pekerjaan" height="100"></canvas>
                            </div>
						...
						<div class="blog-detail-icon marg-bot-50">
                                ...
                                <h5>TABEL DATA DEMOGRAFI BERDASAR PEKERJAAN</h5>
                                 ...
                                 <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="title"><a class="link" href="javascript:void(0)">{{ $datas['pekerjaan'] }}</a></td>
						...
						<div class="friedman-one contact1-form">
							...
							<form action="{{url('komentar/pekerjaan')}}" method="post" class="horizontal">
								@csrf
								<div class="row">
									<div class="col-md-6">
										<input placeholder="Nama" name="nama" type="text">
									</div>
									<input type="hidden" name="keterangan" value="datapekerjaan" >
									<div class="col-md-6">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data){
                    ...
                    for (var i = 0; i < data.dataPekerjaan.length; i++) {
                        pekerjaan.push(data.dataPekerjaan[i].original);
                    }

                    var ctx3 = document.getElementById("pekerjaan").getContext("2d");
