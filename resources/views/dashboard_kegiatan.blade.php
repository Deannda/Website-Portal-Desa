	@extends('master')
		...
		<div class="shop-product col-lg-8 border-bottom" id="konten">
			<br>
							<br>
						<div class="row" >
							 @foreach($allkegiatan as $key => $datas)
							...
							<div class="col-sm-8">
									<div class="shop-product-list">
										<a href="/details_kegiatan/{{$datas->id_kegiatan}}"><h6>{{ $datas->judul }}</h6></a>
										<ul>
										...
										<div class="text-center text-md-left">
											<a href="/details_kegiatan/{{$datas->id_kegiatan}}">Selengkapnya</a>
										</div>
									</div>
								</div>
 							<div class="col-lg-12">
						...
						{{ $allkegiatan->links('vendor.pagination.custom')}}
