  ...
  <!-- SELECT2 EXAMPLE -->
            ...
            <div class="card card-info">
              <div class="card-header">
                ...
                <h3 class="card-title">Edit Anggaran</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{ url('Anggaran/action_edit/'.$datas->id_anggaran) }}" method="post" >
                 @csrf
                <div class="card-body">
               <!--   <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Tahun Anggaran</label>
                    <div class="col-sm-10">
                     <input type="text" class="form-control" name="tahun_anggaran" value="{{ $datas->tahun_anggaran }}" required="">
                    </div>
                  </div> -->
                ...
                <option value="{{ $datas->tahun_anggaran }}">{{ $datas->tahun_anggaran }}</option>
                <?php
                $thn_dpn = 2050;
                ...
                ?>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                               <textarea  class="konten form-control" name="detail"  rows="3" cols="10">{!! $datas->detail !!}</textarea>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info">Edit Anggaran</button>
