...
<section class="content">
  ...
  <div class="card card-info">
    ...
    <form class="form-horizontal" action="{{ url('Kegiatan/action_create') }}" method="post" role="form" enctype="multipart/form-data" >
      @csrf
      <div class="card-body">
       ...
       <div class="form-group row">
         <label class="col-sm-2 col-form-label">Isi Kegiatan</label>
         <div class="col-sm-10">
         ...
         @endforeach
         <div class="form-group row">
           <label class="col-sm-2 col-form-label" for="exampleInputFile">Cover Kegiatan</label>
           <div class="col-sm-10">
         ...
         <div class="card-footer">
          <button type="submit" class="btn btn-info">Tambahkan Kegiatan</button>
