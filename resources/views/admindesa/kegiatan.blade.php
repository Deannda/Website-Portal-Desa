        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
            	  <a class="btn bg-gradient-primary btn-sm" href="{{ url('Kegiatan/create') }}" role="button"><i class="fas fa-plus-square"></i>Tambah Kegiatan</a>
             <!--  <button type="button" class="btn bg-gradient-primary btn-sm" href="{{ url('Kegiatan/create') }}"><i class="fas fa-plus-square"></i> Artikel</button> -->
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><center>
                      ...
                      <!-- <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#details{{ $datas->id_kegiatan }}">
                      <i class="fas fa-info"></i>
                      </button> -->

                        <a class="btn btn-warning btn-sm"  href="{{ url('Kegiatan/edit/'.$datas->id_kegiatan) }}" role="button"><i class="fas fa-edit"></i></a>
                       <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus{{ $datas->id_kegiatan }}">
                  ...
                  <div class="modal fade" id="edit{{ $datas->id_kegiatan }}">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form action="{{ url('Kegiatan/edit/'.$datas->id_kegiatan) }}" method="post" role="form" enctype="multipart/form-data">
                          @csrf
                          <div class="card-body">
                   ...
                   <div class="modal fade" id="hapus{{ $datas->id_kegiatan }}">
                    <div class="modal-dialog">
                      <div class="modal-content bg-danger">
                        ...
                        <div class="modal-footer justify-content-between">
                          ...
                          <a href="{{ url('Kegiatan/hapus/'.$datas->id_kegiatan) }}" type="button" class="btn btn-outline-light">Hapus</a>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                    </div>
